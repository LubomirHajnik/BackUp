...
int min(int count,...) {
    ...
    int min_of_numbers=MAX_ELEMENT;    

    for (int i=0; i<count; i++) {
        new_number=va_arg(value_of_numbers, int);
        
        if (new_number < min_of_numbers) {
            min_of_numbers=new_number;
        }
    }
...
int max(int count,...) {
    ...
    int max_of_numbers=MIN_ELEMENT;    

    for (int i=0; i<count; i++) {
        new_number=va_arg(value_of_numbers, int);
        
        if (new_number > max_of_numbers) {
            max_of_numbers = new_number;
        }
    }
